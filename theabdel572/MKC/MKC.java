...
public class MKC extends JavaPlugin {
	...
	private final String name = ChatColor.AQUA + "[" + ChatColor.GOLD + "MobKillsCounter" + ChatColor.AQUA + "]";
		...
		try {
			...
			if (latestversion.length() <= 7) {
				if (!version.equals(latestversion)) {
					Bukkit.getConsoleSender().sendMessage(name + ChatColor.RED + " There is a new version available. "
